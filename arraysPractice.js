...
addToArray(devMountainEmployees, tyler);
addToArray(devMountainEmployees, cahlan);
addToArray(devMountainEmployees, ryan);
addToArray(devMountainEmployees, colt);
...
var user2 = {
    name: 'Bruce Wayne',
    email: 'totallynotbatman@wayneenterprises.com',
...
var user3 = {
    name: 'Philip Fry',
    email: 'deliveryboy@planetexpress.com',
    password: 'dateMeLeela',
    username: 'inLoveWithACyclops'
};
users.push(user1);
users.push(user2);
users.push(user3);//Your Code Here
